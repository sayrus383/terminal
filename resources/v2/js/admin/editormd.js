...
;(function(factory) {
    ...
    editormd.prototype    = editormd.fn = {
        ...
        loadQueues : function() {
            ...
            editormd.loadCSS("/codemirror/codemirror.min");

            if (settings.searchReplace && !settings.readOnly)
            {
                editormd.loadCSS("/codemirror/addon/dialog/dialog");
                editormd.loadCSS("/codemirror/addon/search/matchesonscrollbar");
            }
            ...
            editormd.loadScript("/codemirror/codemirror.min", function() {
                editormd.$CodeMirror = CodeMirror;

                editormd.loadScript("/codemirror/modes.min", function() {

                    editormd.loadScript("/codemirror/addons.min", function() {
                        ...
                        editormd.loadScript("/lib/marked.min", function() {

                            editormd.$marked = marked;

                            if (settings.previewCodeHighlight)
                            {
                                editormd.loadScript("/lib/prettify.min", function() {
